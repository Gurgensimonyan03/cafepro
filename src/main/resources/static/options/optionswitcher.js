				...
				<div class="tho-option-switcher-btn tho-icon-option">
					...
					<div class="tho-option-swticher-body">
						...
						<ul class="tho-list-unstyled tho-color-options">
							<li class="theme-default theme-active" data-color="restaurex" data-logo="default-logo"></li>
							<li class="theme-color1" data-color="restaurex-color1" data-logo="logo1"></li>
							<li class="theme-color2" data-color="restaurex-color2" data-logo="logo2"></li>
							<li class="theme-color3" data-color="restaurex-color3" data-logo="logo3"></li>
							<li class="theme-color4" data-color="restaurex-color4" data-logo="logo4"></li>
						</ul>
